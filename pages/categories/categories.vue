	...
	<view class="gg">
		...
		<view class="gg-menu-wrap">
			<scroll-view scroll-y class="gg-tab-view menu-scroll-view" scroll-with-animation :scroll-top="scrollTop">
				...
				>
				    <u-image :src="item.imgUrl" border-radius="30rpx" width="50rpx" height="50rpx"></u-image>
			...
			<scroll-view scroll-y class="gg-right-box" @scrolltolower="loadMore">
				...
				<!-- 如果列表没有数据，则显示空内容 -->
				<u-empty :show="searchResult.first && searchResult.empty"></u-empty>
			</scroll-view>
		</view>
	</view>
</template>
